    ...
    <div className="container">
      ...
      <div className="text">
        ...
        <p>
          ...
          tietosuoja-asetuksen määräysten mukaisesti ensimmäisessä
          yhteydenotossa asiakkaaseen tai viimeistään kuukauden sisällä
          henkilötietojen vastaanotosta.
        </p>
        ...
        <h2>Miten tietojani säilytetään ja suojataan?</h2>
        <p>
          ...
          vastaan. Henkilötietojen käsittelyssä ja teknisissä ratkaisuissa
          noudatamme hyviä tietosuojakäytäntöjä mm. tiedon konsolidointi,
          minimointi, pseudonymisointi, anonymisointi ja enkryptaus.
          Henkilötietojen käsittelyssä on huomioitu 25.5.2018 alkaen
          sovellettavan EU:n tietosuoja-asetuksen vaatimukset. Kaikkea pääsyä
          henkilötietoon valvotaan hyvien käytäntöjen mukaisesti.
        </p>
        <h2>Kuka käsittelee henkilötietojani?</h2>
        <p>
          Asiakastietoihin on pääsy vain Verkkokauppa.comin omilla
          työntekijöillä ja henkilökuntamme on koulutettu käyttämään tietoja
          turvallisesti ja eettisesti. Kukin henkilökunnastamme näkee
          asiakastietoja vain niiltä osin kuin se on työtehtävien
          suorittamiselle välttämätöntä. Käytämme luotettuja sopimuskumppaneita,
          jolloin tietoa voidaan siirtää kolmannelle osapuolelle. Kaikkien
          kumppanien kanssa on sopimuksissa huomioitu EU:n tietosuoja-asetuksen
        ...
        <p>
          Säilytämme henkilökohtaisia tietojasi vain tarvittavan ajan, jotta
          voimme täyttää tässä selosteessa kuvatut käyttötarkoitukset. Lisäksi
          joitain tietoja voidaan säilyttää kauemmin niiltä osin kuin se on
          tarpeen laissa asetettujen velvollisuuksien, kuten kirjanpitoa ja
          ...
          anonymisointi-toimenpide on peruuttamaton, emmekä voi palauttaa
          poistettuja asiakastilejä. Osalle tietoa lainsäädäntö asettaa
        ...
        <h2>Millaisia oikeuksia minulla on?</h2>
        ...
        <p>
          Lisäksi, jos käsittely perustuu erilliseen suostumukseen, sinulla on
          oikeus peruuttaa suostumuksesi milloin tahansa. Huomaathan, ettei tämä
          vaikuta ennen suostumuksen peruuttamista suoritettuun tietojen
          käsittelyn lainmukaisuuteen. Voit muuttaa asetuksiasi
          tilinhallinta-sivulla. Voit tehdä oikeuksiesi käyttämistä koskevan
          pyynnön ottamalla yhteyttä asiakaspalveluumme. Pyynnön tulee olla
          riittävällä tavalla yksilöity, jotta asiakaspalvelumme voi todentaa
          henkilöllisyytesi. Ilmoitamme sinulle, mikäli emme joiltain osin pysty
          toteuttamaan pyyntöäsi, kuten poistamaan kaikkia tietoja, joiden
          säilyttämiseen meillä on lakisääteinen velvollisuus (esimerkiksi
          luotonantotiedot) tai oikeus. Jos huomaat, että käsittelyssä on
          puutteita tai se on lainvastaista, sinulla on oikeus tehdä asiasta
        ...
        <p>
          ...
          tietoa tallentamastamme henkilötiedosta.
        </p>
        ...
        <h2>Luovutetaanko henkilötietojani kolmansille osapuolille?</h2>
        <p>
          Voimme luovuttaa joitakin välttämättömiä tietoja kolmansille
          osapuolille toimituksen takaamiseksi sekä markkinointia varten.
          Tietosi välittyvät myös luottopäätöksen yhteydessä luottoa myöntävälle
          taholle. Käytämme asiakastietoja kolmansien osapuolten kanssa myös
          analytiikka- ja personointitarkoituksiin. Hyödynnämme
          ostokäyttäytymis- ja selaustietoja yhteistyökumppanien kanssa, jotta
          voimme paremmin tarjota sinua kiinnostavia tuotteita ja tarjouksia.
          Analytiikka- ja personointitarkoituksiin käytetty tieto on
          anonymisoitua tai pseudonymisoitua aina mahdollisuuksien mukaan. Vain
          me pystymme yhdistämään käytetyn pseudonymisoidun tiedon nimeesi.
          Tarvittaessa luovutamme tietoja myös viranomaisille. Informoimme
          tietopyynnöistä aina myös asiakasta, jos se on lain puitteissa
        ...
        <p>
          ...
          mallisopimuslausekkeet, konsernia sitovat tietosuojasäännökset
          (BCR-järjestely) tai muu tietosuoja-asetuksen mukainen hyväksytty
          tapa. Asiakas voi rajata tietojen luovuttamista markkinointi- ja
          analytiikkatarkoituksiin. Tutustu yksityisyystoimintoihin
          tilinhallinta-sivulla.
        </p>
        ...
        <p>
          ...
          voimassaoloaika, jonka jälkeen selain poistaa tunnisteen. Käytämme
          näitä tekniikoita toimintojen toteuttamiseen, personointiin sekä
          analytiikkaan ja markkinoinnin kohdentamiseen. Toiminnallisia
          evästeitä ja paikallista varastoa käytetään mm. asiakkaan
          tunnistamiseen, kirjautumisen ylläpitämiseen, toimitusaika-arvioihin
          ja ostoskorin toimintoihin. Näihin toimintoihin evästeiden ja
          paikallisen varaston käyttö ja niiden käytön hyväksyminen on
          pakollista. Palvelimen asettamat toiminnalliset evästeet ja
          paikallisen varaston muuttujat säilyvät selaimessa 15min-24kk, ellei
          niitä erikseen poisteta selaimen asetuksista. Sivustolla käynti
          asettaa evästeet ja paikallisen varaston muuttujat uudelleen selaimen
          sen salliessa. Käyttökokemuksen personoinnin avulla voimme tarjota
          sivustollamme enemmän asiakkaitamme kiinnostavia tuotesuositteluja.
          Toimintoa varten asiakkaan selaimeen asetetaan RichRelevancen eväste.
          Nämä evästeet säilyvät selaimessa 30min-24kk. RichRelevancelle
          lähetettävä tieto, kuten tuotesivuilla vierailut ja hakuhistoria, on
          anonymisoitua, eikä yhteistyökumppanin ole mahdollista selvittää
          asiakkaan identiteettiä. Analytiikkaan ja markkinoinnin kohdentamiseen
          käyttämämme yhteistyökumppanit ja tekniikat, kuten kuvapistetunnisteet
          ja evästeet, auttavat meitä ymmärtämään paremmin asiakkaidemme
          käyttäytymistä ja kertovat meille mitkä tuotteet, toiminnot ja
          palvelut asiakkaitamme kiinnostavat. Käytetty tieto on anonymisoitua
          aina kun se on mahdollista. Muutoin käsittelemme tietoja
          henkilökohtaisina niiltä osin kuin tunniste sisältää asiakkaan
          kohdentavia tietoja, kuten IP-osoitteen. Myös tunnisteet, jotka
          voidaan yhdistää asiakkaaseen jollakin tapaa, käsitellään
          henkilökohtaisena tietona. Tunnisteiden voimassaoloaika on 30s-24kk.
          Hyödynnämme Google Analyticsia, Google Tag Manageria, Google
          AdWordsia, Google Display Networkia ja Google DoubleClickiä sivustomme
          käyttöön, suosittuihin tuotteisiin, trendeihin sekä myyntiin
          liittyvässä analytiikassa ja suostumuksellasi myös markkinoinnin
          kohdentamisessa. Googlelle lähetettävä tieto sisältää vain
          anonymisoitua tai pseudonymisoitua tietoa. Lue lisää Google
          Analyticsin tietojen käsittelystä. Tilinhallinnan
          yksityisyystoimintojen lisäksi markkinoinnin kohdentamiseen
          käytetyistä tunnisteista voi kieltäytyä ottamalla käyttöön selaimen Do
          Not Track -toiminnon ja asettamalla selain hylkämään kolmannen
          osapuolen evästeet. Asiakastilille kirjautuneena tilinhallinnan
          yksityisyysasetukset yliajavat selaimen Do Not Track -toiminnon.
        </p>
        <h2>Voidaanko tätä tietosuojaselostetta muuttaa?</h2>
        <p>
          ...
          tietosuojaselosteeseen ilmoitetaan rekisteröityneille asiakkaille
          ehtojen päivityksen yhteydessä.
        </p>
        <h2>Mihin voin ottaa yhteyttä?</h2>
        <p>Voit ottaa yhteyttä sähöpostilla: </p>
        <p>info@yesskiwax.fi</p>
      </div>
    </div>
  );
};
